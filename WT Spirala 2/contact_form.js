...
var regName = /^[a-zA-Z ]+$/;
var regTel = /^\(?[0]{1}[0-9]{2}(\/|\)) ?[0-9]{3}-[0-9]{3}$/; // format broja : 0xx/xxx-xxx
var regMail = /^[a-zA-Z0-9._-]+@[a-zA-Z0-9._-]+\.[a-zA-Z]{2,8}$/; // mail koji dozvoljava samo brojeve i slova i neke specijalne karaktere tipa "_", "." i "-"
var regGrade = /^[0-5]{1}$/; // ocjena treba da bude u rasponu 0-5
var regMsg = /^^(?!\s*$).+$/; // message trazi da bude bar 1 otkucan znak, koji nije samo space/tab
