<?php
	...
	if(isset($_SESSION['login']) && isset($_GET['napravi']) && AvoidXSS($_GET['napravi']) == 1 && file_exists('poruke.xml'))
	{
	...
	else if(isset($_SESSION['login']) && isset($_GET['napravi']) && AvoidXSS($_GET['napravi']) == 2 && file_exists('poruke.xml'))
	{
